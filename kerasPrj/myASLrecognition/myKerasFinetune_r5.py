...
X_train, Y_train = load_data_lbl('C:/Users/mi_o3/Documents/pyCodes_dataset/myASLrecognition/asl_alphabet_train/*',imgW=150,imgH=150,totalImgNum=84000,sampleStep=3)
X_test, Y_test = load_data_lbl('C:/Users/mi_o3/Documents/pyCodes_dataset/myASLrecognition/pyCodes_dataset/myASLrecognition/asl-alphabet-test/*',imgW=150,imgH=150,totalImgNum=840,sampleStep=1)
...
# plt.show()
plt.savefig('myKerasFinetune_r5.png')